...
int main(void)
{
	...
	char temp_array[4] = {0,0,0,0};							
	char space_text[1] = {0x20};									
	
	char header_text[1] = {0x21};								
	char carriage_ret[1] = {0x0D};
	char output_status[4] = {'1','1','1','1'};	
	char UART_buffer[6] = {0,0,0,0,0,0};		
	int i = 0;																	
  ...
  while (1)
  {
		...
		UART_buffer[i] = receive_UART();							
		adcValue = readADCTemp();								 			
		receivedTemp = calculatedTemp(adcValue); 			
		snprintf(temp_array, 5, "%f", receivedTemp); 	
		
		
		if (receivedTemp <= 22) {								
			
			
			((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U))->BSRR |= (0x1U << (24U));
			((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->ODR |= (0x01 << (8U));
			...
			{
				output_status[1] = '0';								
				((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->BSRR |= (0x1U << (26U));
			}
			else if(toggleFan == 0){
				output_status[1] = '1';								
				((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->ODR |= (0x01 << (10U));
			}
			
			if (toggleLight == 1)
			{
				output_status[0] = '0';								
				((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->BSRR |= (0x1U << (16U));
			}
			else if(toggleLight == 0){
				output_status[0] = '1';								
				((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->ODR |= (0x01 << (0U));
			}
			
			
		}
		else if (receivedTemp >= 24) {						
			
			((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->BSRR |= (0x1U << (24U));
			((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U))->ODR |= (0x01 << (8U));
		...
		if(UART_buffer[i] != 0)									
		{
			...
			{
				if (UART_buffer[i] == 0x0A || UART_buffer[i] == 0x0D)	
				{
		...
		if(UART_buffer[0] != '!')	
		{
			...
			transmit_UART(header_text, 1);								
			transmit_UART(temp_array, 4);									
			transmit_UART(space_text, 1);										
			transmit_UART(output_status, 4);							
...
void configGPIOs()
{
	...
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->MODER &= ~((0x3U << (6U)) | (0x3U << (16U)) | 
											(0x3U << (18U)) | (0x3U << (20U)));
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->MODER |= (0x00 << (6U)) | (0x00 << (16U)) | 
											(0x00 << (18U)) | (0x01 << (20U));
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->OTYPER &= ~((0x1U << (3U)) | (0x1U << (8U)) | 
												(0x1U << (9U)) | (0x1U << (10U)));
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->OSPEEDR &= ~((0x3U << (6U)) | (0x3U << (16U)) | 
												(0x3U << (18U)) | (0x3U << (20U)));
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->OSPEEDR |= (0x01 << (6U)) | (0x01 << (16U)) | 
											(0x01 << (18U)) | (0x01 << (20U));
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->PUPDR &= ~((0x3U << (6U)) | (0x3U << (16U)) | 
											(0x3U << (18U)) | (0x3U << (20U)));
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->IDR |= (0x01 << (3U)) | (0x01 << (8U)) | 
									(0x01 << (9U));
	...
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->MODER &= ~((0x3U << (0U)) | (0x3U << (16U)));
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->MODER |= (0x01 << (0U)) | (0x01 << (16U));
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->OTYPER &= ~((0x1U << (0U)) | (0x1U << (8U))); 
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->OSPEEDR &= ~((0x3U << (0U)) | (0x3U << (16U))); 
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->OSPEEDR |= (0x01 << (0U)) | (0x01 << (16U)); 
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->PUPDR &= ~((0x3U << (0U)) | (0x3U << (16U)));						
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->ODR |= (0x01 << (10U));
	...
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U))->OSPEEDR &= ~((0x3U << (16U)) | (0x3U << (20U))); 
...
void configUSART()
{
	...
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->MODER &= ~((0x3U << (20U)) | (0x3U << (22U)));
	
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->MODER |= (0x02 << (20U)) | (0x02 << (22U));
	...
	((USART_TypeDef *) (0x40000000U + 0x4800U))->BRR |= (0x2D << (4U)) | (0x09 << (0U));	
	...
	((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U))->CR3 &= ~((0x1U << (9U)) | (0x1U << (8U)));
	
	
	((USART_TypeDef *) (0x40000000U + 0x4800U))->CR1 |= ((0x1U << (3U)) | (0x1U << (2U)) | (0x1U << (13U)));
...
void configADC()
{
	...
	((ADC_Common_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2300U))->CCR |= (0x03 << (16U));
...
void configTimer()
{
	...
	((TIM_TypeDef *) (0x40000000U + 0x1000U))->PSC |= 0x5208;									
...
void LEDs_off()
{
	...
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->ODR |= (0x01 << (10U));
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->ODR |= (0x01 << (0U) | 0x01 << (8U));
	((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1400U))->ODR |= (0x01 << (8U));
}
...
uint16_t readADCTemp()
{
	...
	currentTemp = (((ADC_TypeDef *) ((0x40000000U + 0x00010000U) + 0x2200U))->DR & 0x0000FFFF);
...
int8_t receive_UART()
{
	...
	if(((USART_TypeDef *) (0x40000000U + 0x4800U))->SR & (0x1U << (5U)))
	{
		...
		UART_value = ((USART_TypeDef *) (0x40000000U + 0x4800U))->DR;
...
void transmit_UART(char character[], int size)
{
	...
	for(i = 0; i < size; i++)
	{
		...
		((USART_TypeDef *) (0x40000000U + 0x4800U))->DR = character[i];
		while((((USART_TypeDef *) (0x40000000U + 0x4800U))->SR & (0x1U << (6U))) == 0);
	}
}
...
{	
	...
	((TIM_TypeDef *) (0x40000000U + 0x1000U))->ARR |= countVal;
...
{	
	...
	uint16_t maskSWs = 0xFCF7; 			
	uint16_t fanSW = 0xFFF7;				
	uint16_t lightSW = 0xDFFF;			
	uint16_t lightSensor = 0xEFFF;	
	uint16_t readSWs = ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U))->IDR;	
	readSWs |= maskSWs;							
